...
function showDataHealthReport(report) {
  ...
  const fixableTotal = fixableSeq + fixableUsage + fixableNeg + fixableDup + fixableEmpty + fixableBuyMismatch + r.issues.filter(x => x.code === 'SUBTOTAL_INCONSISTENT').length;
  let fixBtns = '';
